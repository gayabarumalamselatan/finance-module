...
const PurchaseRequestTable = ({
  ...
  const handleEditPurchaseRequest = (value) => {
    ...
    if (dataSelected[0].STATUS_REQUEST === "IN_PROCESS" && (!checker || userId !== dataSelected[0].REQUESTOR || dataSelected[0].STATUS === "APPROVED")) {
      Swal.fire({
        icon: "warning",
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          const responseDetail = await LookupService.fetchLookupData(`PURC_FORMPUREQD&filterBy=PR_NUMBER&filterValue=${prNumber}&operation=EQUAL`, authToken, branchId);
              ...
              <div>
                <div className="container">
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-md-8">{dateFormat(selectedRowData.SCHEDULE_DATE)}</div>
                  </div>
                  <div className="row mb-3">
